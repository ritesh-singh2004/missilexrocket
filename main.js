...
function updateMissileSpecs(m) {
    ...
    document.getElementById('missile-name').textContent = d.name;
    document.getElementById('spec-range').textContent = d.range;
    document.getElementById('spec-type').textContent = d.type;
    document.getElementById('spec-payload').textContent = d.payload;
    document.getElementById('spec-missile-stages').textContent = d.stages;
}

function filterProjects(cat) {
    document.querySelectorAll('.project-card').forEach(c => {
        if (cat === 'all' || c.getAttribute('data-category') === cat) { c.style.display = 'block'; }
